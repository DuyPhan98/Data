...
print(X)
y = df_encoded['Strain capacity (%)']
print(y)

#Splitting the data into two set for training and testing...................................
from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.3, random_state = 42)
# Inport and training pure DT.............................................................................
from sklearn.tree import DecisionTreeRegressor
regressor = DecisionTreeRegressor(max_depth=100, min_samples_leaf=1, min_samples_split=10, max_features=45, random_state=10)
...
# Export to Excel
results_df.to_excel('cross_validation_results from DT model.xlsx', index=False, engine='openpyxl')

print("Cross-validation results saved to 'cross_validation_results from DT model.xlsx'")
...
pd.DataFrame(y_train, columns=['Experiment training_DTBO']).to_csv('Experiment training_DTBO.csv')
pd.DataFrame(y_pred, columns=['Prediction training_DTBO']).to_csv('Prediction training_DTBO.csv')
# Collection  testing data
y_test= np.array(y_test)
print(y_predtest)
pd.DataFrame(y_test, columns=['Experiment testing_DTBO']).to_csv('Experiment testing_DTBO.csv')
pd.DataFrame(y_predtest, columns=['Prediction testing_DTBO']).to_csv('Prediction testing_DTBO.csv')
...
plt.legend(["Experiment","Pure KNN"])
plt.xlim(0, 350)
plt.ylim(0,10)
